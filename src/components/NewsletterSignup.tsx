    ...
    <section className="px-6 py-24 border-t border-zinc-100">
      <div className="max-w-6xl mx-auto grid sm:grid-cols-2 gap-12">
        ...
        <div className="flex flex-col gap-4 sm:border-l sm:border-zinc-100 sm:pl-12">
          ...
          <a
            href="/work-with-me"
            className="inline-flex items-center gap-2 bg-zinc-900 text-white text-sm font-semibold px-5 py-2.5 rounded-full hover:bg-zinc-700 transition-colors self-start"
          >
            Get in touch →
          </a>
        </div>
