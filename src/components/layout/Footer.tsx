  ...
  return (
    <footer className={cn('border-t-2 border-card px-6 py-8', className)}>
      <div className="max-w-[1080px] mx-auto flex items-center gap-4 flex-wrap">
        ...
        <span className="font-px text-xs text-mint">OHHEYLYNAE</span>
        <span className="font-px text-[9px] text-ink-soft">© 2026 · GG</span>
        <div className="ml-auto flex gap-[18px] font-sans font-semibold text-sm">
          ...
          <a
            ...
            className="inline-flex items-center gap-1 text-peri hover:text-mint transition-colors"
          >
