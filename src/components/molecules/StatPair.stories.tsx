...
const meta = {
  ...
  tags: ['autodocs'],
  argTypes: {
    tone: { control: 'select', options: ['link', 'primary', 'accent', 'gold'] },
    value: { control: 'text' },
    label: { control: 'text' },
  },
  args: {
  ...
  render: () => {
    ...
    return (
      <div>
        ...
        <h2 className="mb-1 font-pixel text-2xl text-primary">STAT / LABEL</h2>
        <p className="mb-8 max-w-xl font-sans text-sm leading-relaxed text-ink-soft">
          ...
          flash. Empty values render as <code className="font-mono text-xs text-accent">—</code>.
          Optional <code className="font-mono text-xs text-accent">onClick</code> drills into that
          stat.
        </p>
        ...
        <div
          ...
          style={{ borderRadius: 10 }}
        >
          <StatPair value={null} label="CLIPS" tone="primary" />
          <StatPair value="" label="RAIDS" tone="accent" />
        </div>
        ...
        >
          <StatPair
            ...
            tone="link"
          />
          <StatPair value={`${views.toFixed(1)}K`} label="VIEWS" tone="primary" />
          <button
            type="button"
