        ...
        <div className={cn('inline-flex border border-line-strong w-full', className)}>
          {prev && (
            <a
              ...
              href={prev.href}
            >
              <span className="font-mono text-xxs tracking-wide text-ink-mute uppercase">← PREV</span>
          ...
          {next && (
            <a
              ...
              href={next.href}
            >
              <span className="font-mono text-xxs tracking-wide text-ink-mute uppercase">NEXT →</span>
