...
export const Showcase: Story = {
  ...
  render: () => (
    <div>
      ...
      <h2 className="font-px text-2xl text-mint mb-1">AVATAR</h2>
      ...
      >
        {(['face', 'bust', 'round'] as const).map((variant) => (
          <div key={variant} className="flex flex-col items-center gap-2">
            <Avatar variant={variant} size={72} ring="mint" />
      ...
      >
        {PRESETS.map((size) => (
          <div key={size} className="flex flex-col items-center gap-2">
            <Avatar size={size > 128 ? 96 : size} ring="mint" />
      ...
      <div
        ...
        style={{ borderRadius: 10 }}
      >
        <Avatar variant="face" size={64} ring="mint" presence="online" />
        <Avatar variant="bust" size={64} ring="pink" />
