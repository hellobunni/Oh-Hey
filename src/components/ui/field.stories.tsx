...
function ThemePanel({
  ...
  return (
    ...
    >
      <div className={`font-pixel text-xs ${theme === 'light' ? 'text-ink' : 'text-primary'}`}>
...
export const LightDark: Story = {
  ...
  render: () => (
    <div className="flex flex-col gap-7 bg-deep p-12 text-paper-ink">
      <div className="font-pixel text-[22px] text-primary">FORM FIELDS — ALL TYPES & VARIANTS</div>
      ...
      {/* Text input */}
      <div className="border-b-2 border-card pb-2 font-pixel text-[15px] text-accent">TEXT INPUT</div>
