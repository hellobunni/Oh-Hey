  ...
  return (
    <div className={cn("text-center", className)}>
      ...
      <h3 className="font-pixel text-2xl text-ink leading-snug">
        ONE LETTER, <span className="text-accent">EVERY OTHER SUNDAY.</span>
      </h3>
      <p className="mt-3.5 font-sans font-medium text-sm text-ink-soft max-w-[400px] mx-auto">
        Whatever I made, lifted, drew, or read that week. No tracking, no
        sponsors, easy unsubscribe.
      </p>
      ...
      {status === "done" ? (
        ...
        <form
          ...
          className="mt-7 flex shadow-[5px_5px_0_rgba(0,0,0,0.4)] max-w-[480px] mx-auto"
        >
          <input
            type="email"
            required
          ...
          <button
            ...
            className="font-pixel text-xs bg-primary text-ink border-0 px-5 cursor-pointer transition-colors hover:bg-accent disabled:opacity-50 whitespace-nowrap"
          >
            {status === "loading" ? "..." : "+1UP"}
          </button>
        </form>
