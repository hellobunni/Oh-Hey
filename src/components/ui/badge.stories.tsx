...
export const LightDark: Story = {
  ...
  render: () => (
    <div className="flex flex-col gap-7 bg-deep p-12 text-paper-ink">
      <div className="font-pixel text-[22px] text-primary">
        TAG & BADGE — TWO SEPARATE COMPONENTS-3
      </div>
      <p className="max-w-[760px] font-sans text-sm font-semibold text-ink-soft">
        Tag = static label/category, square, pixel font, no interaction. Badge =
        status signal, pill or dot, sans font. Numeric quantity lives on the
        Count atom.
      </p>

      {/* ── Tag ─────────────────────────────────────────────────────────── */}
      <div className="font-pixel text-[15px] text-accent border-b-2 border-card pb-2">
        TAG COMPONENT
      </div>
      ...
      {/* ── Badge ───────────────────────────────────────────────────────── */}
      <div className="font-pixel text-[15px] text-accent border-b-2 border-card pb-2 mt-3">
        BADGE COMPONENT
      </div>
...
export const Tags: Story = {
  ...
  render: () => (
    <div>
      ...
      <h2 className="mb-1 font-pixel text-2xl text-primary">TAGS</h2>
      <p className="mb-8 max-w-xl font-sans text-sm leading-relaxed text-ink-soft">
        Static content labels in Silkscreen with sharp corners. Neutral flips
        with paper/ink; primary and outline hold brand hexes in both modes. Not
        interactive.
      </p>
...
export const Badges: Story = {
  ...
  render: () => (
    <div>
      ...
      <h2 className="mb-1 font-pixel text-2xl text-primary">BADGES</h2>
      <p className="mb-8 max-w-xl font-sans text-sm leading-relaxed text-ink-soft">
        Status signals in Quicksand bold. Mint / pink / neutral tones; pill
        (default) or status dot. For numeric quantity, use the{" "}
        <code className="font-mono text-xs text-accent">Count</code> atom. Pass{" "}
        <code className="font-mono text-xs text-accent">interactive</code> for
        filter-chip scale on hover.
      </p>
      ...
      <div
        ...
        style={{ borderRadius: 10 }}
      >
        <Badge interactive tone="mint">
          LIVE
        </Badge>
        <Badge interactive tone="pink">
          NEW
        </Badge>
        <Badge interactive tone="neutral">
          ALL
        </Badge>
      </div>
