...
export const LightDark: Story = {
  ...
  render: () => (
    <div className="flex flex-col gap-7 bg-deep p-12 text-paper-ink">
      <div className="font-pixel text-[22px] text-primary">TAG & BADGE — TWO SEPARATE COMPONENTS</div>
  ...
  render: () => (
    <div>
      ...
      <p className="mb-8 max-w-xl font-sans text-sm leading-relaxed text-ink-soft">
        ...
        dot. For numeric quantity, use the <code className="font-mono text-xs text-accent">Count</code> atom.
        Pass <code className="font-mono text-xs text-accent">interactive</code> for filter-chip
        scale on hover.
      </p>
