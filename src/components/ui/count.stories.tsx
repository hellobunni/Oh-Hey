...
const meta = {
  ...
  argTypes: {
    tone: { control: 'select', options: ['alert', 'mint'] },
...
export const LightDark: Story = {
  ...
  render: () => (
    <div className="flex flex-col gap-7 bg-deep p-12 text-paper-ink">
      <div className="font-px text-[22px] text-mint">COUNT — ATOM</div>
      ...
      <div className="border-b-2 border-card pb-2 font-px text-[15px] text-pink">VARIANTS</div>
...
export const Showcase: Story = {
  ...
  render: () => (
    <div>
      ...
      <h2 className="mb-1 font-px text-2xl text-mint">COUNT</h2>
      <p className="mb-8 max-w-xl font-sans text-sm leading-relaxed text-ink-soft">
        Quantity only. Truncates above <code className="font-mono text-xs text-pink">max</code>{' '}
      ...
      >
        ...
        <Count shape="dot" tone="mint" aria-label="New" />
      </div>
      ...
      >
        ...
        <div className="relative">
          <Avatar size={44} ring="mint" />
          <Count value={12} size="sm" placement="overlay" tone="mint" />
        </div>
        <div className="relative">
          <Avatar size={64} ring="pink" />
